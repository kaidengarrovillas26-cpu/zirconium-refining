runAfterLoad(function() {
    elements.zirconium_sand = {
        ...
        conduct: 0.1,
        reactions: {
            "sodium_hydroxide": { elem1: "sodium_zirconate", elem2: "sodium_silicate", chance: 0.01 },
            "water": { elem1: "wet_zirconium_sand", elem2: null, chance: 0.1 }
        }
    };
    ...
    elements.sodium_zirconate = {
        ...
        conduct: 0.01,
        reactions: {
            "water": { elem1: "zirconyl_hydroxide", elem2: null, chance: 0.05 }
        }
    };
    ...
    elements.zirconyl_hydroxide = {
        ...
        conduct: 0.58,
        reactions: {
            "hydrochloric_acid": { elem1: "zirconium_oxychloride", elem2: "water", chance: 0.01 },
            "sulfuric_acid": { elem1: "zirconium_sulfate", elem2: "water", chance: 0.01 },
            "nitric_acid": { elem1: "zirconium_nitrate", elem2: "water", chance: 0.01 }
        }
    };
    ...
    elements.sulfur_trioxide = {
        ...
        conduct: 0,
        reactions: {
            "water": { elem1: "sulfuric_acid", elem2: null, chance: 0.05 }
        }
    };
    ...
    elements.sulfur_dioxide = {
        ...
        conduct: 0,
        reactions: {
            "water": { elem1: "sulfuric_acid", elem2: null, chance: 0.1 },
            "oxygen": { elem1: "sulfur_trioxide_gas", elem2: null, chance: 0.01, tempMin: 400 }
        }
    };
    ...
    elements.zirconium_oxide = {
        ...
        conduct: 0,
        reactions: {
            "chlorine": { elem1: "zirconium_tetrachloride", elem2: "carbon_dioxide", tempMin: 1000, chance: 0.01 }
        }
    };
    ...
    elements.zirconium_tetrachloride = {
        ...
        conduct: 0,
        reactions: {
            "water": { elem1: "zirconium_oxychloride", elem2: "hydrochloric_acid", chance: 0.2, tempMin: 20 }
        }
    };
    ...
    elements.silica = {
        ...
        conduct: 0,
        reactions: {
            "sodium_oxide": { elem1: "sodium_silicate", elem2: null, tempMin: 800, chance: 0.1 }
        }
    };
    ...
    elements.zirconium_tetrachloride_gas = {
        ...
        conduct: 0,
        reactions: {
            "molten_magnesium": { elem1: "dirty_zirconium_sponge", elem2: "magnesium_chloride", tempMin: 800, chance: 0.01 }
        }
    };
    ...
    elements.zirconium = {
        ...
        conduct: 0.23,
        reactions: {
            "water": { elem1: "zirconium_oxide", elem2: "hydrogen", chance: 0.01 }
        }
    };
});
